...
function Header() {
	...
	const handleRegister = () => {
		fetch('https://morning-news-frontend-three.vercel.app/users/signup', {
			method: 'POST',
	...
	const handleConnection = () => {
		...
		fetch('https://morning-news-frontend-three.vercel.app/users/signin', {
			method: 'POST',
			headers: { 'Content-Type': 'application/json' },
	...
	if (user.token) {
		userSection = (
			<div className={styles.logoutSection}>
				...
				<FontAwesomeIcon onClick={handleShowArticles} className={styles.userSection} icon={faEye} />
